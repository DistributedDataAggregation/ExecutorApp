...
ThreadData* worker_group_get_thread_data(const QueryRequest* request, int thread_index, int num_threads,
                                         ...
                                         HashTableInterface* hash_table_interface, int* entries_limit, ErrorInfo* err);
...
int* worker_group_hash_table_entries_limits(RowGroupsRange** row_group_ranges, int num_threads, int num_files,
                                            ErrorInfo* err);
