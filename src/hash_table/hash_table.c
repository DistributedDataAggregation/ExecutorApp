...
HashTableValue combine_hash_table_int_value(HashTableValue current_value, HashTableValue incoming_value,
                                            ErrorInfo* err);
HashTableValue combine_hash_table_float_value(HashTableValue current_value, HashTableValue incoming_value,
                                              ErrorInfo* err);
HashTableValue combine_hash_table_double_value(HashTableValue current_value, HashTableValue incoming_value,
                                               ErrorInfo* err);
...
HashTableValue combine_hash_table_int_value(HashTableValue current_value, const HashTableValue incoming_value,
                                            ErrorInfo* err)
{
...
HashTableValue combine_hash_table_float_value(HashTableValue current_value, const HashTableValue incoming_value,
                                              ErrorInfo* err)
{
    switch (current_value.aggregate_function)
    {
...
HashTableValue combine_hash_table_double_value(HashTableValue current_value, const HashTableValue incoming_value,
                                               ErrorInfo* err)
{
    switch (current_value.aggregate_function)
    {
    case MIN:
        {
            current_value.double_value = incoming_value.double_value < current_value.double_value
                                             ? incoming_value.double_value
...
HashTableValue map_partial_result_to_table_value(PartialResult* pr_value, ErrorInfo* err)
{
    ...
    if (pr_value == NULL)
    {
        ...
        SET_ERR(err, INTERNAL_ERROR, "Null parameter passed",
                "Received null pr value in map_partial_result_to_table_value");
        return ht_value;
    }
