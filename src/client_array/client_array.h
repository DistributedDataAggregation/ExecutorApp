...
void client_array_init(ClientArray* array, size_t initial_capacity, ErrorInfo* err);

void client_array_add_client(ClientArray* array, int client_fd, ErrorInfo* err);

void client_array_accept_clients(ClientArray* array, int socket_fd, const fd_set* read_fds, ErrorInfo* err);
